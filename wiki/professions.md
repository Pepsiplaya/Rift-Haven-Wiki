...
- The main profession panel is `/skills`.
...
- `Crafting` still exists in some saved-data compatibility paths, but live progression has been split into more specific profession tracks.
...
1. Start Mining and Foraging early.
2. Use Mining to feed Smithing and Weaponsmithing.
3. Use hides/fibers for Leatherworking and Weaving.
4. Use Foraging plus creature drops to feed Cooking and Alchemy.
5. Use gems, bars, and essences to push Jewelcrafting.
6. Convert excess essences into concentrated/greater essence progression later.
