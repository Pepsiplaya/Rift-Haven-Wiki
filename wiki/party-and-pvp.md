...
- Arena world defaults to `pvp`.
- Arena spawn protection duration: 3 seconds.
- Arena deaths trigger fast respawn teleport flow.
- `/arena leave` returns you to safe fallback/previous location flow.

## 4) Progression path

1. Learn party controls early (`/p`).
2. Run dungeons/rifts with fixed teammate roles.
3. Use arena sessions to sharpen class mechanics under pressure.
4. Tune party settings and invite flow to reduce downtime.
