...
Welcome to the public player wiki for Rift Haven.

Latest patch and announcements: [discord.gg/RiftHaven](https://www.discord.gg/RiftHaven)
...
- [Sol Elementalist](wiki/classes/sol-elementalist.md)
...
- New players who want a clean first-session path.
- Returning players catching up to current systems.
- Group players planning dungeons, rifts, and class synergies.
- Crafters and economy players who want gold/profession loops.

## 3) Core rules (exact mechanics)

- Class level cap is 30.
- Talent unlocks happen every 5 class levels.
- Profession level cap is 100.
- Current launch paths are one active subclass per class:
- Fighter -> Fury
- Paladin -> Light
- Elementalist -> Sol
- Rogue -> Shinobi
...
- Class milestones: 5, 10, 15, 20, 25, 30.
- Profession milestones: 15, 30, 45, 60, 85.
- Rift contribution tiers: Bronze, Silver, Gold.
- Dungeon ready checks and requeue windows can speed repeat runs.
